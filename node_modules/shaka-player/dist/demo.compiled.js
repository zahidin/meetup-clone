...
$jscomp.iteratorFromArray=function(a,b){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var c=0,e={next:function(){if(c<a.length){var d=c++;return{value:b(d,a[d]),done:!1}}e.next=function(){return{done:!0,value:void 0}};return e.next()}};e[Symbol.iterator]=function(){return e};return e};var shakaDemo=shakaDemo||{};shakaDemo.onlineOptGroups_=[];
...
[];0<=d.features.indexOf(shakaAssets.Feature.WEBM)&&h.push("video/webm");0<=d.features.indexOf(shakaAssets.Feature.MP4)&&h.push("video/mp4");0<=d.features.indexOf(shakaAssets.Feature.MP2TS)&&h.push("video/mp2t");h.some(function(a){return shakaDemo.support_.media[a]})||(f.disabled=!0);f.disabled||e.disabled||(c=c||f,d.focus&&(c=f))}});c&&(c.selected=!0);var e=shakaDemo.setupOfflineAssets_(),d=document.createElement("option");d.textContent="(custom asset)";a.appendChild(d);a.addEventListener("change",
...
c);var k="uncompiled",h="#"+a.join(";");"build"in b?(a.push("build="+b.build),k=b.build):"compiled"in b&&(a.push("build=compiled"),k="compiled");["compiled","debug_compiled","uncompiled"].forEach(function(a){var b=document.getElementById(a+"_link");k==a?(b.classList.add("disabled_link"),b.removeAttribute("href"),b.title="currently selected"):(b.classList.remove("disabled_link"),b.onclick=function(){location.hash=h+";build="+a;location.reload();return!1})});try{eval("()=>{}")}catch(l){b=document.getElementById("uncompiled_link"),
b.classList.add("disabled_link"),b.removeAttribute("href"),b.title="requires ES6"}a="#"+a.join(";");a!=location.hash&&(shakaDemo.suppressHashChangeEvent_=!0,location.hash=a);location.search&&(location.search="")}};shakaDemo.onErrorEvent_=function(a){shakaDemo.onError_(a.detail)};
...
shakaDemo.updateButtons_=function(a){var b=document.getElementById("assetList"),c=shakaDemo.offlineOperationInProgress_;document.getElementById("progressDiv").style.display=a&&!c?"none":"block";a=b.options[b.selectedIndex];var e=a.storedContent,d=b=!0;a.asset&&a.asset.drm&&a.asset.drm.length&&(b=a.asset.drm.some(function(a){return shakaDemo.support_.drm[a]&&shakaDemo.support_.drm[a].persistentState}),d=Object.keys(shakaDemo.support_.drm).some(function(a){return shakaDemo.support_.drm[a]&&shakaDemo.support_.drm[a].persistentState}));
document.getElementById("offlineNameDiv").style.display=a.asset?"none":"block";var f=document.getElementById("storeDeleteButton");f.disabled=!1;f.textContent=e?"Delete":"Store";e=document.getElementById("storeDeleteHelpText");c?(f.disabled=!0,e.textContent="Operation is in progress..."):d?b?a.isStored?(f.disabled=!0,e.textContent='The asset is stored offline. Checkout the "Offline" section in the "Asset" list'):e.textContent="":(f.disabled=!0,e.textContent="This browser does not support persistent licenses for any DRM system in this asset."):
(f.disabled=!0,e.textContent="This browser does not support persistent licenses.")};shakaDemo.setupOffline_=function(){document.getElementById("storeDeleteButton").addEventListener("click",shakaDemo.storeDeleteAsset_);document.getElementById("assetList").addEventListener("change",shakaDemo.updateButtons_.bind(null,!0));shakaDemo.updateButtons_(!0)};
...
shakaAssets.testAssets.length;g++){var k=shakaAssets.testAssets[g];if(f==k.manifestUri){shakaDemo.preparePlayer_(k);break}}d=e.remove(d).then(function(){for(var b=0;b<a.options.length;b++){var c=a.options[b];c.asset&&c.asset.manifestUri==f&&(c.isStored=!1)}return shakaDemo.refreshAssetList_()})}else{d=shakaDemo.preparePlayer_(c.asset);g=document.getElementById("offlineName").value;var h=d.name?"[OFFLINE] "+d.name:null;d=e.store(d.manifestUri,{name:h||g||d.manifestUri}).then(function(){c.asset&&(c.isStored=
!0);return shakaDemo.refreshAssetList_().then(function(){for(var b=shakaDemo.offlineOptGroup_,c=0;c<b.childNodes.length;c++){var d=b.childNodes[c];d.textContent==h&&(a.selectedIndex=d.index)}})})}d["catch"](function(a){shakaDemo.onError_(a)}).then(function(){shakaDemo.offlineOperationInProgress_=!1;shakaDemo.updateButtons_(!0);return e.destroy()})};shakaDemo.refreshAssetList_=function(){for(var a=shakaDemo.offlineOptGroup_;a.firstChild;)a.removeChild(a.firstChild);return shakaDemo.setupOfflineAssets_()};
